...
5. [クラス・関数 IPO詳細](#4-クラス関数-ipo詳細)
   ...
   - [4.4 情報なし回答検知（④'・二段判定）](#44-情報なし回答検知④二段判定)
   - [4.5 強制エスカレ（④・二段判定）](#45-強制エスカレ④二段判定)
...
| 2.4 | 目次の §4.4〜§4.7 へのリンクが見出しの丸数字（④・⑥）を含むアンカーと一致せず切れていたのを修正（2026-09-24） |
